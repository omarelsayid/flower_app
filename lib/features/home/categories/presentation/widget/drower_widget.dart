    ...
    return Container(
      ...
      child: Stack(
        children: [
                        ...
                        child: FloatingActionButton(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                S.of(context).filter,
                                style: AppTextStyles.inter500_16.copyWith(color: AppColors.whiteColor),
                              ),
                            ],
                          ), // لون الزر
                        ),
          ...
          Positioned(
            left:
            ((currentRangeValues.start / 1000) * resposiveWidth(ScreenSizeService.baseWidth - 20)>
              ((currentRangeValues.end / 1000) * resposiveWidth(ScreenSizeService.baseWidth -70))-30)?
            ( ((currentRangeValues.end / 1000) * resposiveWidth(ScreenSizeService.baseWidth -70))-30) :
        (currentRangeValues.start / 1000) * resposiveWidth(ScreenSizeService.baseWidth - 20),
          ...
          Positioned(
            left: (currentRangeValues.end / 1000) * resposiveWidth(ScreenSizeService.baseWidth -50),
            bottom: resposiveHeight(90),
            child: SizedBox(
              width: resposiveWidth(60),
